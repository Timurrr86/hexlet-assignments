...
class ValidationTest {
    ...
    void testAdvanceValidate() {
        ...
        Map<String, List<String>> expected4 = Map.of("country", List.of("length less than 4"), "street", List.of("can not be null"));
        assertThat(notValidFields).isEqualTo(expected4);
    }
    // END
}
